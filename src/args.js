...
// Todo: artificed uses argparse, artifice uses commander - consolidate on one command line library?

const parser = new argparse.ArgumentParser({
  version: version,
  addHelp: true,
  description: `ARTIFICE demon v${version}: ARTIC Real Time Integrated Field Infection Control Edifice`,
  epilog: `
